...
<?php
echo '<footer style="text-align: center; padding: 5px; background-color: #f8f9fa; position: fixed; bottom: 0; width: 100%;">';
echo '<h3>José Mauricio López García, Carnet: 5190-21-352</h3>';  
echo '<h3>Emerson Sebastian Hernandez Rojas, Carnet: 5190-20-21989</h3>';  
echo '<p>';
